...
import ProgressBarRecipeImage from './ProgressBarRecipeImage';
...
const UploadForm = () => {
  const [fileRecipe, setFile] = useState(null);
  ...
  return (
    <form>
      ...
      <div className="output">
        ...
        { fileRecipe && <div>{ fileRecipe.name }</div> }
        { fileRecipe && <ProgressBarRecipeImage fileRecipe={fileRecipe} setFile={setFile} /> }
      </div>
    </form>
  );
}
